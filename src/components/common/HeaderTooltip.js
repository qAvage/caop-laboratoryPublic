...
const HeaderTooltip = ({ showTooltip, title, content, idx, onLeft }, { emit }) => {
  const UISVGIcon = resolveComponent('UISVGIcon')
  idx = String(idx)
  return h('div', { class: onLeft ? 'tooltip on-left' : 'tooltip', id: 'tooltip' + idx },
    [
      h('div', {
        class: 'bg',
...
HeaderTooltip.emits = ['mouseOver', 'mouseOut']
HeaderTooltip.props = ['showTooltip', 'title', 'content', 'idx', 'onLeft']
